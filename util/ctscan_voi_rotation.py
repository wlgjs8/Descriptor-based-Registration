...
class CTScanDataset_Center(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if original_scan_image.vertices.shape[0]>self.SAMPLE_CNT:
        ...
        scan_normals = original_scan_image.vertex_normals[idx]
        print('scan_normals : ', scan_normals.shape)
        ...
        # high_curvature_indices = torch.from_numpy(high_curvature_indices)
        print('high_curvature_indices : ', high_curvature_indices)
