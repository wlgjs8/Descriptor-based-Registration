...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    # checkpoint_path = os.path.abspath('/home/jeeheon/Documents/point-transformer/exp/s3dis/pointtransformer_repro/model/infonce5e-2/model_best.pth')
    # checkpoint_path = os.path.abspath('/home/jeeheon/Documents/point-transformer/exp/s3dis/pointtransformer_repro/model/infonce neg500/model_best.pth')
...
def validate(val_loader, ct_model, scan_model, criterion):
    ...
    for i, (ct_image, matched_pair_gradient, coord, feat, target, offset) in enumerate(val_loader):  # (n, 3), (n, c), (n), (b)
        ...
        utils.bef_cal_rank(scan_output, coord, ct_output, matched_pair)
        utils.bef_cal_rank_gradient(scan_output, coord, ct_output, matched_pair, matched_gradient)
